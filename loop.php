...
<?php /* How to display posts in the Gallery category. */ ?>
	...
	<?php if ( in_category( _x('gallery', 'gallery category slug', 'progo') ) ) : ?>
...
<?php else : ?>			
				...
				?>
						...
						<p><em><?php printf( __( 'This gallery contains <a %1$s>%2$s photos</a>.', 'progo' ),
								'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'progo' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
								$total_images
							); ?></em></p>
				<?php endif; ?>
						<?php the_excerpt(); ?>
...
<?php /* How to display posts in the asides category */ ?>
	...
	<?php elseif ( in_category( _x('asides', 'asides category slug', 'progo') ) ) : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
